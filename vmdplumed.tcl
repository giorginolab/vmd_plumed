...
#    $w.menubar.file.menu add separator
    ...
    $w.menubar.help.menu add command -label "How to install the 'driver' binary" \
	-command "vmd_open_url http://www.multiscalelab.org/toni/PlumedCVTool"
    $w.menubar.help.menu add command -label "On PLUMED" \
        -command "vmd_open_url http://www.plumed-code.org"
    $w.menubar.help.menu add command -label "PLUMED user's guide and CV syntax" \
