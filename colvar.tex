...
inclusion in one or the other set~\cite{plumed_manual}.  
...
optimal alignment, and the measure of the RMSD.
...
with different topologies are arranged changing the \emph{target
