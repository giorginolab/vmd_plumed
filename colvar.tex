...
\begin{figure}
  \centering
  \subfigure[Main window]{\includegraphics[width=0.7\textwidth]{images/main} \label{fig:main}}
  \subfigure[Templates menu]{\includegraphics[width=0.23\textwidth]{images/templates} \label{fig:templates}}
...
The author would like to thank the authors of PLUMED and VMD for
creating, distributing and supporting the corresponding software
packages. Part of the work described in this paper was conducted while
at the Computational Biophysics Laboratory at the Universitat Pompeu
Fabra (Barcelona). Former support from the ``Beatriu de Pin\'os''
scheme of the Ag\`encia de Gesti\'o d'Ajuts Universitaris i de Recerca
