...
\bibitem{2}Humphrey, W., A. Dalke, and K. Schulten. ``VMD: Visual
...
The following paper should appear in the same journal issue as
the one describing Plumed 2.0 \emph{engine}. Plumed-GUI relies on
either (or both) Plumed 1.3 and 2.0; here we show features available
